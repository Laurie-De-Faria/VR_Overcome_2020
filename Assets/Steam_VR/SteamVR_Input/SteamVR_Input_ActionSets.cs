...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_MoveHand p_MoveHand;
        ...
        public static SteamVR_Input_ActionSet_MoveHand MoveHand
        {
            get
            {
                return SteamVR_Actions.p_MoveHand.GetCopy<SteamVR_Input_ActionSet_MoveHand>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_MoveHand = ((SteamVR_Input_ActionSet_MoveHand)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_MoveHand>("/actions/MoveHand")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.MoveHand};
        }
    }
}
